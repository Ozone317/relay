...
public class EventController {
    ...
    @PostMapping("/events")
    public ResponseEntity<EventResponseDto> create(@PathVariable UUID environmentId, @PathVariable UUID appId,
            @AuthenticationPrincipal AuthenticatedUser user, @RequestBody @Valid EventCreateDto request) {
    ...
    @GetMapping("/events")
    public ResponseEntity<List<EventResponseDto>> getAll(@PathVariable UUID environmentId, @PathVariable UUID appId,
