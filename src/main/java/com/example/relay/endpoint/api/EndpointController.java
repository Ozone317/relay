...
public class EndpointController {
    ...
    public ResponseEntity<EndpointResponseDto> create(
        @PathVariable UUID environmentId,
        @PathVariable UUID appId,
        @AuthenticationPrincipal AuthenticatedUser user,
        @RequestBody @Valid EndpointCreateDto request
    ...
    public ResponseEntity<EndpointResponseDto> getById(
        @PathVariable UUID environmentId,
        @PathVariable UUID appId,
    ...
    public ResponseEntity<List<EndpointResponseDto>> getAll(
        @PathVariable UUID environmentId,
        @PathVariable UUID appId,
        @AuthenticationPrincipal AuthenticatedUser user
    ) {
    ...
    public ResponseEntity<EndpointResponseDto> update(
        @PathVariable UUID environmentId,
        @PathVariable UUID appId,
        @PathVariable UUID endpointId,
        @AuthenticationPrincipal AuthenticatedUser user,
        @RequestBody @Valid EndpointUpdateDto request
    ) throws EndpointNotFoundException {
        Endpoint endpoint = endpointService.update(
            request,
            endpointId,
            appId,
            environmentId,
