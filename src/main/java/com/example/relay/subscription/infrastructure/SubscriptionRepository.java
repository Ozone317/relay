...
public interface SubscriptionRepository extends JpaRepository<Subscription, UUID> {
    ...
    @Query("""
            ...
            """)
    List<Subscription> findAllByAppIdAndEnvironmentIdAndUserId(UUID appId, UUID environmentId, UUID userId);
    ...
    @Query("""
                ...
                WHERE
                    ...
                    AND s.app.environment.user.id = :userId
            """)
    List<Subscription> findAllByAppIdAndEnvironmentIdAndEndpointIdAndUserId(UUID appId, UUID environmentId,
            UUID endpointId, UUID userId);
    ...
    @Query("""
                ...
                WHERE
                    ...
                    AND s.app.environment.user.id = :userId
            """)
    Optional<Subscription> findByAppIdAndEnvironmentIdAndEventIdAndEndpointIdAndUserId(UUID appId, UUID environmentId,
            UUID eventId, UUID endpointId, UUID userId);
