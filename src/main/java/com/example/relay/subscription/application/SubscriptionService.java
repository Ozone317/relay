...
public class SubscriptionService {
    ...
    public Subscription create(
        ...
        Subscription created = subscriptionRepository.save(
            new Subscription(app, event, endpoint)
        );
    ...
    public List<Subscription> getAll(
        ...
        List<Subscription> subscriptions = subscriptionRepository.findAllByAppIdAndEnvironmentIdAndEndpointIdAndUserId(
            appId,
            environmentId,
            endpointId,
            userId
    ...
    private Optional<Subscription> getSubscription(
        ...
        return subscriptionRepository.findByAppIdAndEnvironmentIdAndEventIdAndEndpointIdAndUserId(
            appId,
            environmentId,
            eventId,
            endpointId,
