...
public class AppController {
    ...
    @PostMapping("/apps")
    public ResponseEntity<AppResponseDto> create(@PathVariable UUID environmentId,
            @Valid @RequestBody AppCreateDto request, @AuthenticationPrincipal AuthenticatedUser user) {
    ...
    @GetMapping("/apps")
    public ResponseEntity<List<AppResponseDto>> getAll(@PathVariable UUID environmentId,
            @AuthenticationPrincipal AuthenticatedUser user) throws EnvironmentNotFoundException {
    ...
    public ResponseEntity<AppResponseDto> getById(@PathVariable UUID environmentId, @PathVariable UUID appId,
            @AuthenticationPrincipal AuthenticatedUser user) throws AppNotFoundException {
