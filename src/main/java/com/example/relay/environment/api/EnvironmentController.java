...
public class EnvironmentController {
    ...
    @PostMapping
    public ResponseEntity<EnvironmentResponseDto> create(
    ...
    @GetMapping("/{id}")
    public EnvironmentResponseDto getById(
    ...
    @PatchMapping("/{id}")
    public EnvironmentResponseDto partialUpdate(
        @PathVariable UUID id,
        @Valid @RequestBody EnvironmentUpdateDto request,
        @AuthenticationPrincipal AuthenticatedUser user
    ) {
